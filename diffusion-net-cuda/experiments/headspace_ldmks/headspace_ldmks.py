...
test_dataset = HeadspaceLdmksDataset(dataset_path, data_format, train=False, num_landmarks=n_class, k_eig=k_eig, use_cache=True, op_cache_dir=op_cache_dir)
test_loader = DataLoader(test_dataset, batch_size=None)


# Load the train dataset
if train:
    train_dataset = HeadspaceLdmksDataset(dataset_path, data_format, train=True, num_landmarks=n_class, k_eig=k_eig, use_cache=True, op_cache_dir=op_cache_dir)
