...
\begin{table*}[t]
\captionof{table}{\textbf{Model configuration.} Models are trained on an Nvidia Titan V. *Diffusion is truncated to an Eigenbasis of k = 128 for spectral acceleration. **HKS is sampled at $F=16$ values of t logarithmically spaced on [0.01, 1]}
